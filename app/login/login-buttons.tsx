...
export function LoginButtons({ callbackUrl }: { callbackUrl: string }) {
  ...
  function handleSignIn(provider: "discord" | "google") {
    setLoading(provider);
  ...
  return (
    <div className="space-y-3">
      <Button
        ...
        disabled={!!loading}
        size="lg"
        className="w-full bg-[#5865F2] text-white shadow-[0_4px_24px_-8px_#5865F2] hover:bg-[#4752C4]"
      >
        {loading === "discord" ? (
      ...
      >
        {loading === "google" ? (
          ...
          <svg viewBox="0 0 24 24" className="h-5 w-5">
            ...
            <path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18A10.99 10.99 0 0 0 1 12c0 1.77.42 3.44 1.18 4.93l2.85-2.22.81-.62z" fill="#FBBC05" />
